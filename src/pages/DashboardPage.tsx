...
const dashboardCards = [
  {
    ...
    description: 'Manage assignments, exams, notes & timetable',
    icon: BookOpen,
    path: '/university',
    color: 'text-primary',
  },
  {
    title: 'Career Hub',
    description: 'Plan your career path & build skills',
    icon: Briefcase,
    path: '/career',
  ...
  },
  {
    ...
    description: 'Discover internships & job openings',
    icon: TrendingUp,
    path: '/jobs',
    color: 'text-primary',
  },
  {
    ...
    description: 'Get instant help with coding & career',
    icon: MessageSquare,
    path: '/ai-mentor',
    color: 'text-secondary',
  },
  ...
  {
    title: 'Daily Goals',
    description: 'Set and track your daily objectives',
    icon: Target,
    path: '/goals',
    color: 'text-secondary',
  },
  ...
  return (
    <Layout>
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          <h1 className="text-4xl font-bold gradient-text mb-2">Home</h1>
